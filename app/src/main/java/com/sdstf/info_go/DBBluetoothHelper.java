...
public class DBBluetoothHelper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "infoGo";
    private static final String TABLE_NAME= "bluetoothDetails";
    ...
    public DBBluetoothHelper(Context context){
    ...
    public boolean insertBluetooth(String title, String results, double latitude, double longitude, String timestamp){
    ...
    public boolean updateBluetooth(Integer id, String title, String results, double latitude, double longitude, String timestamp)
    {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(KEY_TITLE, title);
    ...
    public Integer deleteBluetooth(Integer id)
    {
        SQLiteDatabase db = this.getWritableDatabase();
    ...
    public ArrayList<String> getAllBlueTooth()
    {
